...
namespace Movie_DB_Search
{
    public partial class TMDB_Form : Form
    {
        ...
        public void searchMovie()
        {
            ...
            {
                var json = wc.DownloadString(searchFunction);
            }

            dynamic jsonConvert = JsonConvert.SerializeObject(json);

            dynamic fields = JsonConvert.DeserializeObject("{ 'original_title': '', 'release_date': '', 'genres': '', 'vote_average': '' }");

            string name = fields.original_title;
            string release_date = fields.release_date;
            string genres = fields.genres;
            string vote_average = fields.vote_average;
            string poster_path = fields.poster;
            ...
            movieName.Text = Convert.ToString(jsonConvert[0]["title"].Value);
